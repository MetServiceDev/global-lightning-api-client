...
/**
 * Bespoke MetService lightning format, v1
 */
export interface BlitzenVersion1 {
	/**
	 ...
	 */
	direction?: BlitzenVersion1.DirectionEnum;
}
export namespace BlitzenVersion1 {
...
export type BlitzenCollectionV1 = BlitzenVersion1[];
