 ...
 */
import { BlitzenVersion2Ellipse } from './blitzenVersion2Ellipse';
import { BlitzenVersion3SensorDetails } from './blitzenVersion3SensorDetails';

/**
 * Bespoke MetService lightning format, v3
 */
export interface BlitzenVersion3 {
	/**
	...
	longitude?: number;
	/**
	 * Epoch milliseconds. The number of seconds after Jan 1 1970 UTC that this occurred, convert this to local time using the- appropriate Date library.
	 */
	timeMillis?: number;
	/**
	...
	/**
	 * a datetime string in UTC in the format YYYY-MM-dd'T'hh:ss:mm.SSS'Z'
	 */
	dateTime?: string;
	/**
	 * The amplitude of the strike in kA with polarity (+/-)
	 */
	amplitude?: number;
	/**
	 * The type of strike, whether CLOUD (cloud-to-cloud) or GROUND (cloud-to-ground).
	 */
	direction?: BlitzenVersion3.DirectionEnum;
	ellipse?: BlitzenVersion2Ellipse;
	sensorDetails?: BlitzenVersion3SensorDetails;
}
export namespace BlitzenVersion3 {
	export type DirectionEnum = 'CLOUD' | 'GROUND';
	export const DirectionEnum = {
		CLOUD: 'CLOUD' as DirectionEnum,
		GROUND: 'GROUND' as DirectionEnum,
	};
}

export type BlitzenCollectionV3 = BlitzenVersion3[];
